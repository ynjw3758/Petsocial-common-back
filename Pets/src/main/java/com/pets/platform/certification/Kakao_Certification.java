...
@Service
public class Kakao_Certification {
	...
	public Map<String, Object> create_kakao(Map<String ,Object> kakao_info){
		logger.info("카카오 엑세스 토큰 :" + kakao_info.get("kakao_info"));
		...
		infos = (Map<String, Object>) kakao_info.get("kakao_info");
	...
	//카카오 로그인
	public Map<String, Object>kakao_login(String code , HttpServletRequest tokens){
		...
		String headers="";
		String paload_info="";
		headers = json.get("id_token").toString().split("\\.")[0];
		paload_info = json.get("id_token").toString().split("\\.")[1];
		...
		if(user_check == true) {
		    ...
		    properties = (Map<String, Object>) user_infos.get("properties");
			...
			return result_data;
		    	...
		    	Map<String, Object> data = new HashMap<String ,Object>();
		    	Map<String, Object> kakao = new HashMap<String ,Object>();
		    	data= mapper.Kakao_Search_id(user_infos.get("email").toString());
			    Map<String, Object> properties = new HashMap<String ,Object>();
			    properties = (Map<String, Object>) user_infos.get("properties");
			    logger.info("proper : " + properties);
			    
			    kakao.put("id", user_infos.get("id"));
			    kakao.put("email", user_infos.get("email").toString());
			    kakao.put("nickname", properties.get("nickname").toString());
			    kakao.put("gender", user_infos.get("gender").toString());
			    kakao.put("profile_img", properties.get("profile_image").toString());
	...
	public Map<String ,Object> user_info(String token){
		...
		logger.info("사용자 정보 조회 결과값 : " + user_info);
